...
l2=new JLabel("Page 1: Persnol Details");
...
add(l5);
l13.setBounds(300,240,40,30);add(l13);
c1.setBounds(340,240,60,25);
add(c1);
l14.setBounds(410,240,50,30);add(l14);
c2.setBounds(460,240,100,25);
add(c2);
l15.setBounds(570,240,40,30);add(l15);
c3.setBounds(610,240,90,25);
add(c3);
...
r5.setBounds(636,390,100,30);add(r5);
